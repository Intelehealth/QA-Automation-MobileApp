...
// Clicking on the next button after entering vital details
		...
		startVisit1And2StepsPage.checkVitalsUpdateScreenDetailsEditable(expectedChangedVitalsDetailsInSummary);startVisit1And2StepsPage.selectBloodgroup();
		startVisit1And2StepsPage.clickOnFirstVitalsNextButton();
...
// Select all reasons on the page
	 ...
	 * @throws InterruptedException
	 */
	@Test(priority = 17, description = "Verify the options displayed for the 1st question", enabled = false)
	 ...
	 * @throws InterruptedException
	 */
//	@Test(priority = 21, description = "Verify the Describe section of 3 of 12 questions screen", enabled = false)
	...
	@Test(priority = 22, description = "Verify by not selecting any options and click on submit button of 2 of 12", enabled = false)
	...
	@Test(priority = 24, description = "Verify selecting any duration in 3 of 12", enabled = false)
...
// Click on the submit button to proceed to the next set of questions
		...
		startVisit1And2StepsPage.scrollDown();
// Verify that a calendar interface for selecting dates is displayed
		startVisit1And2StepsPage.selectmenstruationDate();String selectedmenstruationDate= startVisit1And2StepsPage.getSelectedMenstruationDate();

		Assert.assertTrue(startVisit1And2StepsPage.verifySelectedMenstruationDateIsDisplayed(selectedmenstruationDate));
	}
...
//		startVisit1And2StepsPage.clickOnEightAssociatedSymptomYesButton();
	...
	public void IDA4_2551_verifyChangeButtonOfAbdominalPain() throws InterruptedException {
		 ...
		 * startVisit1And2StepsPage.scrollToEndAction(); for (int i = 0; i < 4; i++) {
		 * scrollDown(); }
		 */
		startVisit1And2StepsPage.selectAssociatedSymptoms();
		startVisit1And2StepsPage.clickOnAssociatedSymptomMainSubmitButton();
