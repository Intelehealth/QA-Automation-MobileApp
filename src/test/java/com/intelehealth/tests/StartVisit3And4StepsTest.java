...
public class StartVisit3And4StepsTest extends BaseTest {
	...
	@Test(priority = 1, description = "Verify 1 of 6 questions is shown to user", enabled = false)
	...
	@Test(priority = 2, description = "Verify 1 of 6 questions is shown to user", enabled = false)
	...
	@Test(priority = 3, description = "Verify when user selects Take a picture in 1 of 6", enabled = false)
	...
	@Test(priority = 4, description = "Verify when user clicks on upload icon in 1 of 6", enabled = false)
	...
	@Test(priority = 5, description = "Verify 2 of 6 questions is shown to user", enabled = false)
	...
	@Test(priority = 6, description = "Verify when user clicks Normal/Pale option in 2 of 6", enabled = false)
	...
	@Test(priority = 7, description = "Verify 3 of 6 questions is shown to user", enabled = false)
	...
	@Test(priority = 8, description = "Verify when user clicks Normal/Slow option in 3 of 6", enabled = false)
	...
	@Test(priority = 9, description = "Verify 4 of 6 questions is shown to user", enabled = false)
	...
	@Test(priority = 10, description = "Verify when user clicks Nails are normal/Clubbing/Spoon nails/Discolored option in 4 of 6", enabled = false)
	...
	@Test(priority = 11, description = "Verify 5 of 6 questions is shown to user ", enabled = false)
	...
	@Test(priority = 12, description = "Verify when user clicks Nails are normal/Nails are pale option in 5 of 6", enabled = false)
	...
	@Test(priority = 13, description = "Verify when user clicks Nails are normal/Nails are pale option in 5 of 6", enabled = false)
	...
	/////////////////// *************************************************************************************************************************
	@Test(priority = 14, description = "Verify when user clicks -No oedema/In left/In right/Both option in 6 of 6", enabled = false)
	...
	@Test(priority = 15, description = "Verify Change button functionality on Physical examination summary screen", enabled = false)
	...
	@Test(priority = 16, description = "Verify Back button functionality on Physical examination summary screen", enabled = false)
	...
	@Test(priority = 17, description = "Verify Back button functionality on Physical examination summary screen", enabled = false)
	...
	@Test(priority = 18, description = "Verify the UI of Family history screen", enabled = false)
	...
	@Test(priority = 19, description = "Verify one or more options can be selected for the question on Family history screen", enabled = false)
	...
	@Test(priority = 20, description = "Verify if Other option is selected on Family history screen", enabled = false)
	...
	@Test(priority = 21, description = "Verify the user is able to enter data into the textbox on Family history screen", enabled = false)
	...
	@Test(priority = 22, description = "Verify confirm button functionality on Family history screen", enabled = false)
	...
	@Test(priority = 23, description = "Verify Change button functionality for patient history on Medical history summary screen", enabled = false)
	...
	@Test(priority = 24, description = "Verify Change button functionality for family history on Medical history summary screen", enabled = false)
	...
	@Test(priority = 25, description = "Verify Back button functionality on Medical history summary screen", enabled = false)
	...
	@Test(priority = 26, description = "Verify Confirm button functionality on Medical history summary screen", enabled = false)
	...
	@Test(priority = 27, description = "Verify that user can select one or more options for the questions allowed on Patient history screen", enabled = false)
	...
	@Test(priority = 28, description = "Verify Skip functionality on Patient history screen", enabled = false)
	...
	///////////////////////////////////
	@Test(priority = 29, description = "Verify Submit functionality on Patient history screen", enabled = false)
	...
	@Test(priority = 30, description = "Verify Other [Describe] textbox functionality on Patient history screen", enabled = false)
	...
	@Test(priority = 31, description = "Verify dropdowns for selecting durations on Patient history screen", enabled = false)
	...
	@Test(priority = 32, description = "Verify calendar selection option on Patient history screen", enabled = false)
	...
	@Test(priority = 33, description = "Verify whether the selected date appears correctly on Patient history screen", enabled = false)
	...
	@Test(priority = 34, description = "Verify whether the changes are updated in physical examination screen", enabled = false)
	...
	@Test(priority = 35, description = "Verify whether the changes are updated in medical history summary screen", enabled = false)
	...
	@Test(priority = 36, description = "Verify Describe section of the question on Family history screen", enabled = false)
	...
	@Test(priority = 37, description = "Verify clicking photo in 1 of 6", enabled = false)
	...
	@Test(priority = 38, description = "Verify clicking photo in 1 of 6", enabled = false)
	...
	@Test(priority = 39, description = "Verify when user selects take photo option in 4 of 6", enabled = false)
	...
	@Test(priority = 40, description = "Verify when user selects take photo option in 5 of 6", enabled = false)
	...
	@Test(priority = 41, description = "Verify when user selects take photo option in 6 of 6", enabled = false)
	...
	@Test(priority = 42, description = "Verify picture is uploaded when selected from gallery/photos in 1 of 6", enabled = false)
	...
	@Test(priority = 43, description = "Verify picture is uploaded when selected from gallery/photos in 2 of 6", enabled = false)
	...
	@Test(priority = 44, description = "Verify picture is uploaded when selected from gallery/photos in 4 of 6", enabled = false)
	...
	@Test(priority = 45, description = "Verify picture is uploaded when selected from gallery/photos in 4 of 6", enabled = false)
	...
	@Test(priority = 46, description = "Verify picture is uploaded when selected from gallery/photos in 6 of 6", enabled = false)
