...
public class StartVisit3And4StepsPage extends BaseTest {
	...
	@AndroidFindBy(xpath = "(//android.widget.EditText[@resource-id=\"org.intelehealth.app:id/actv_reasons\"])[last()]")
	private WebElement fourthOtherDescriptionInput;
	...
	@AndroidFindBy(id = "org.intelehealth.app:id/image")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_name\" and @text=\"Take a picture\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_question\" and @text=\"Upload an image from gallery or take a picture\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_name\" and @text=\"Normal\"]")
	private WebElement normal;
	
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_name\" and @text=\"Pale\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_question\" and @text=\"General exams : Pinch skin*\"]")
	...
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id=\"org.intelehealth.app:id/tv_name\" and @text=\"Slow\"]")
...
//						+ "new UiSelector().description(\"Hypertension\").instance(0));"));
	...
	//	click(twoOfSixQuestionsNoButton);
		...
		sendKeys(fourthOtherDescriptionInput, "Testing");
		scrollDown();
		click(submitButton);
...
// Verify upload options after clicking on take a picture
	public void verifyUploadIcon() throws InterruptedException {
		click(oneOfSixQuestionsTakePictureOption, "Clicked on 'Take a Picture' option"); click(imageCaptureButton);
		...
		click(takePhoto, "Take Photo option is displayed");
		click(photoCaptureButton, "Clicked on Image Capture button");
		click(uploadButton, "Clicked on Image upload button");
	}
